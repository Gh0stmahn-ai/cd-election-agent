...
<section class="prose">
  ...
  <div class="step"><div class="n">5</div><div>
    ...
    exactly where the rater put it. This changes little among toss-ups, which Cook has already sorted
    tightly, and a great deal among safe seats, where the old model treated a Solid R district at D+12 as
    being exactly as safe as one at R+33. The ten states that redrew mid-decade are excluded, because the
    published index still describes their old lines.</p>
    ...
    nested layers: national, census division, state, and the seat itself. Two districts in the same state
